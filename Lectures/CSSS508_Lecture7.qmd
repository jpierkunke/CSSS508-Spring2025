...
Note these data are *fairly large* in their native `.csv` format. The following code can be used to download the data directly from Vic's `Github` page as a smaller, `.Rdata` object:
