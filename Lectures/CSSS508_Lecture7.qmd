...
## Escaping with Strings {.scrollable}
...
## Other Special Characters {.scrollable}
...
## Data: King County Restaurant Inspections! {.scrollable}
...
## Quick Examination of the Data {.scrollable}
...
## Example #1 with Restaurant Data {.scrollable}
...
## Example #2 with Restaurant Data {.scrollable}
...
## Example #3 with Restaurant Data {.scrollable}
...
11. Notice that when a variable has spaces in its name (rather than being separated with an underscore in snake_case, for instance) you need to put backticks around it so `R` knows it is a singular object name.

## Example #4 with Restaurant Data {.scrollable}
...
## Separating Character Strings into Multiple Variables {.scrollable}
...
## Example with Restaurant Data {.scrollable}
...
## `separate_wider_*` functions {.scrollable}
...
## Modifying Strings: Converting Cases {.scrollable}
...
## Modifying Strings: Removing Whitespace {.scrollable}
...
## Counting Characters {.scrollable}
...
## Working with Non-English Strings {.scrollable}
...
## Patterns: `str_detect()` {.scrollable}
...
## Replacement: `str_replace()` {.scrollable}
...
## What are Regular Expressions? {.scrollable}
...
## Separation with regex {auto-animate="true"} {.scrollable}
...
## Separation with regex {.scrollable}
...
## Other Uses for Regular Expressions {.scrollable}
...
## [list.files()]{.color-red}  {.scrollable}
...
## [pivot_longer()]{.color-blue}  {.scrollable}
...
## [separate_*_delim()]{.color-blue}  {.scrollable}
...
## Base `R` Equivalents^[You can see a full list [here](https://stringr.tidyverse.org/articles/from-base.html), including functions we didn't look at today.] {.scrollable}
...
## {data-menu-title="Homework 7" background-iframe="https://jpierkunke.github.io/CSSS508-Spring2025/Homework/homeworky.html" background-interactive=TRUE}
