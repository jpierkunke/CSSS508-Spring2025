...
## Some reasons I love R, RStudio, and Quarto

My research:

![Making pretty maps, doing analyses](figures/benchmark_networks.png)
...
The syllabus (as well as lots of other information) can be found on our [course website](https://jpierkunke.github.io/CSSS508-Spring2025/)
...
All course content (lecture slides and homework instructions) will be accessible on our [course website](https://jpierkunke.github.io/CSSS508-Spring2025/).
...
Homework/peer grading instructions and deadlines can be found on the [Homework](https://jpierkunke.github.io/CSSS508-Spring2025/Homework/homework.html) page of the course website. All homework will be turned in on Canvas **by 4:30pm the day it is due**.
...
::: {.callout-tip icon=false}
## Feedback
If you have feedback on any part of this course or the classroom environment I want to hear it! You can submit anonymous feedback [here](https://forms.gle/ukzZQn5XGQDia2jG9). I will also send out a mid-quarter feedback survey.
:::
...
::: {.incremental}
1. The bars in the bottom left-hand corner will show you a table of contents for the entire slideshow, allowing you to find what you're looking for more easily. 
2. If you hover over any chunk of `R` code embedded in the slides you will see a clipboard which you can click to copy the code. You can then paste it in your own Quarto document or `R` script to run it in your session of RStudio. 
3. To get a PDF version of these slides click *File* > *Print* from your internet browser, select *Save as PDF* as the Destination or Printer, and make sure the Layout is set to *Landscape*. (Note: the *PDF Export Mode* in *Tools* actually cuts off content which is why I'm not recommending it)
4. Clicking on the paintbrush in the bottom left-hand corner allows you to draw directly on the slides, in a very Microsoft Paint kind of way. See if it's useful but I make no promises!
5. Type **?** at any time to see all the available key-board shortcuts. 
6. Some pages are scrollable.
:::
...
* Produce many different document types as output
  ...
  + Websites (like the one for [this course](https://jpierkunke.github.io/CSSS508-Spring2025/)!)
* Works with LaTeX and HTML for math and more formatting control
:::

## Downloading R and RStudio 

If you don't already have R and RStudio on your machine, now is the time to do so! Follow the instructions in the [syllabus](https://jpierkunke.github.io/CSSS508-Spring2025/syllabus.html).
...
* In quarto documents, click within a code chunk and click the green arrow <span>&emsp;&nbsp;</span> ![](images/rstudio_run_current_chunk.png){.absolute top=355 right=135} to run the chunk. The button beside that (<span>&emsp;&emsp;</span> ![](images/rstudio_run_all_chunks_above.png){.absolute top=392 right=615}) runs *all prior chunks*.
...
Anything written after `#`^[In Quarto documents, comments only work in code chunks. Outside of a chunk, `#` creates **headers** like "comments" at the top of this slide.] will be ignored by R. 
...
4. Save this document somewhere (you can delete it later) (either with *File > Save* or clicking <span>&emsp;&ensp;</span> ![](images/rstudio_save.png){.absolute top=284 left=23} towards the top left of the source pane).
5. Lastly, click <span>&emsp;&emsp;</span> ![](images/rstudio_render.png){.absolute top=320 left=157} Render at the top of the source pan to "knit" your document into an html file. This will produce a minimal webpage since we only have a title. We need to add more content!
...
This is all basic markdown syntax which you can learn about [here](https://quarto.org/docs/authoring/markdown-basics.html).
...
As of this writing there are 22,254 [available packages](https://cran.rstudio.com/)!
...
## {data-menu-title="Homework 1" background-iframe="https://jpierkunke.github.io/CSSS508-Spring2025/Homework/homework1.html" background-interactive=TRUE}
