...
# Vocab review{.section-title background-color="#99a486"}

## General coding vocab {.scrollable}
...
You can read more about the specific style we're using in this class [here](https://style.tidyverse.org/).
...
**Enter the pipe^[A component of programming which allows us to break a problem into a number of steps, each of which is straightforward and easy to understand.]:** `|>`
...
## Organization and Portability {.scrollable}
...
Each data analysis (*or course using R*) should be organized as a [**project**]{.highlight-tableaured}. 
...
## Solution: 3. *Option* + *Shift* + *K* / *Alt* + *Shift* + *K* 
...
2. Either the class itself is an RStudio project or each homework assignment subfolder is a separate project
...
## `data.frame()` vs. `tibble()` {.scrollable} 
...
## Selecting from dataframes with `[[` and `$` {.scrollable} 
...
## {data-menu-title="Homework 3" background-iframe="https://jpierkunke.github.io/CSSS508-Spring2025/Homework/homework3.html" background-interactive=TRUE}
