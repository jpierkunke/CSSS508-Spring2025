...
-   **Homework (75%; 3 points):** These must be submitted as pdf documents; we will go over how to create these. I will grade these assignments for completion (3 points if submitted, 0 otherwise) and provide feedback on your work. These are designed first and foremost to develop skills rather than "prove" you have learned concepts. I encourage you to communicate and work together, so long as you write and explain your code yourself and do not copy work.
